...
date: '2022-08-18'
draft: false
summary: Ubuntu や Debian に最新の Node.js をインストールする方法。
---

※記載のバージョンは記事執筆時点のものです。最新とは異なる場合がありますが、インストールスクリプトは問題なく最新バージョンをインストールできます。
...
<Details title="Node.js LTS (16.x)">
...
<Details title="Node.js 最新版 (18.x)">
